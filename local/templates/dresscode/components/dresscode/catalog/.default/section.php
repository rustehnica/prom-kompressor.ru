...
<?
	...
	elseif($obCache->StartDataCache()){
		...
		$arCurSection = array();
		$dbRes = CIBlockSection::GetList(array(), $arFilter, false, array("ID", "CODE", "NAME", "IBLOCK_ID", "DEPTH_LEVEL", "DESCRIPTION", "UF_TOP_DESCRIPTION", "UF_TOP_ADVANTAGES"));
...
<?endif;?>
<?global $USER;if(!empty($arCurSection["UF_TOP_DESCRIPTION"]) && empty($arTags)):?>
	<?if(!DwSettings::isPagen()):?>
		<div class="sectionTopDescription"><?=$arCurSection["~UF_TOP_DESCRIPTION"]?></div>
	<?endif;?>
<?endif;?>
<?//преимущества?>
<?if($arCurSection["UF_TOP_ADVANTAGES"]):?>
