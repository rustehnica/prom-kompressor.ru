...
// описание раздела для карточки
	$arFilter = array('IBLOCK_ID' => $arResult['IBLOCK_ID'], "ID" => $arResult['IBLOCK_SECTION_ID']);
	$rsSect = CIBlockSection::GetList(array(),$arFilter, false, array("UF_TOP_DESCRIPTION"));
	while ($arSect = $rsSect->GetNext())
	{
	   $arResult['SECTION_DESCRIPTION'] = $arSect['~UF_TOP_DESCRIPTION'];
	}	