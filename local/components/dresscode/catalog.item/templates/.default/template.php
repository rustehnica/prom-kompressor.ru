		    ...
		    <div class="productTable">
		    	...
		    	<div class="productColText">
					...
					<div class="propContainer">
						...
						<?if($arResult["PROPERTIES"]["auto_MOSHCHNOST_DVIGATELYA"]["VALUE"]):?><?=$arResult["PROPERTIES"]["auto_MOSHCHNOST_DVIGATELYA"]["NAME"]?> : <?=$arResult["PROPERTIES"]["auto_MOSHCHNOST_DVIGATELYA"]["VALUE"]?> кВт<br><?else:?><?endif;?>
						<?if($arResult["PROPERTIES"]["auto_PROIZVODITELNOST"]["VALUE"]):?><?=$arResult["PROPERTIES"]["auto_PROIZVODITELNOST"]["NAME"]?> : <?=$arResult["PROPERTIES"]["auto_PROIZVODITELNOST"]["VALUE"]?> л/мин<br><?else:?>&nbsp;<?endif;?>
						<?if($arResult["PROPERTIES"]["MAKSIMALNOE_DAVLENIE"]["VALUE"]):?><?=$arResult["PROPERTIES"]["MAKSIMALNOE_DAVLENIE"]["NAME"]?> : <?=$arResult["PROPERTIES"]["MAKSIMALNOE_DAVLENIE"]["VALUE"]?> атм<?else:?>&nbsp;<?endif;?>
